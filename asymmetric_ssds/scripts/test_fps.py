...
from asymmetric_ssds.utils.other import make_video_from_rgb_imgs
import time
...
for substrate_name in sorted(['collaborative_cooking__asymmetric']):
    ...
    top_video_name = "{}".format(env_config['substrate'])
    make_video_from_rgb_imgs(frames_top, vid_path='.', video_name=top_video_name, resize=(1200, 800))
